  ...
  return (
    <>
      ...
      <div className="text-white container  mx-auto pb-32 pt-14">
        ...
        <div className="flex gap-5 justify-around ">
          <div className="item space-y-3 flex flex-col items-center justify-center">
            ...
            <p className=" text-center">Your fans are available for you to </p>
          </div>
          <div className="item space-y-3 flex flex-col items-center justify-center">
            <img
              className="bg-slate-400 rounded-full p-2 text-black"
      ...
      <div className="text-white container mx-auto pb-32 pt-14 flex flex-col items-center justify-center">
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/55c6IlV7BEo?si=BSMQ1MScsmMx6prX" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
      </div>
    </>
  );
}
